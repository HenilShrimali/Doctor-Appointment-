...
function ClinicAppointments() {
  ...
  const filteredAppointments = appointments.filter((apt) => {
    ...
    const matchesSearch =
      ...
      apt.doctorId?.name?.toLowerCase().includes(filters.search.toLowerCase());
  ...
  const exportToCSV = () => {
    const headers = ["Date", "Time", "Patient", "Doctor", "Status", "Amount"];
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div className="flex gap-2">
              <input
                ...
                className="flex-1 px-4 py-2 border text-black border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-transparent"
              />
              <button
                onClick={exportToCSV}
